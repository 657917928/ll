...
from tg_order.models import OrderInfo
from tg_user.models import UserInfo
from django.core.paginator import Paginator
from tg_cart.models import *


# Create your views here.
def register(request):
    return render(request, 'tg_user/register.html')
...
def register_exist(requset):
    ...
    count = UserInfo.objects.filter(uname=uname).count()# 个数0或者1
    return JsonResponse({'count': count}) #返回
...
def login(request):
    ...
    return render(request, 'tg_user/login.html', context)
...
def info(request):
    ...
    return render(request, 'tg_user/user_center_info.html', context)
...
def order(request):
    ...
    return render(request, 'tg_user/user_center_order.html', context)
...
def site(request):
    ...
    return render(request, 'tg_user/user_center_site.html', context)
