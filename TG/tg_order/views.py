...
from tg_order.models import OrderInfo,OrderDetailInfo
from tg_user.islogin import islogin
from tg_cart.models import CartInfo
...
def order(request):
    ...
    return render(request, 'tg_order/place_order.html', context)
...
def pay(request,oid):
    ...
    print (order.oid)
    context = {'oid': oid}
    return render(request, 'tg_order/pay.html', context)